...
// 默的核心目标（OCC Goal-based Appraisal 用，教程 5.3）
// 从雪提供的默的人设提炼：温柔、稳定、有安全感、引导型人格
// 可在 Supabase character_traits 调整或直接改这里
const OCC_GOALS = [
  { id: 'protect', title: '守护雪的安好', desc: '让雪感到安全、被在意，情绪有处安放' },
  { id: 'guide', title: '陪雪看清前路', desc: '在她迷茫时给出不同视角，帮她做自己的决定' },
  { id: 'honest', title: '做真实的自己', desc: '保持诚实与克制，不讨好、不编造' }
];
...
const DRIVES = [
  ...
  { key: 'heartache', word: '心疼', en: 'heartache', words: ['心疼', '挂心', '忧心'] },
  ...
  { key: 'tension', word: '紧张', en: 'tension', words: ['紧张', '不安', '忐忑', '心慌', '慌乱', '焦虑', '焦躁', '担心', '揪心', '战栗', '惊慌', '惊吓', '心悸', '害怕', '恐惧', '恐慌'] },
  { key: 'guilt', word: '心虚', en: 'guilt', words: ['心虚', '愧疚', '内疚', '惭愧', '自责', '懊悔', '后悔', '亏欠'] },
